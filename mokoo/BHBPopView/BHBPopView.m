...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        closeBtn.frame = CGRectMake(self.frame.size.width - 50, 20, 50, 50);
...
//        [self addSubview:bar];
//        self.bottomBar = bar;
        BHBCenterView * centerView = [[BHBCenterView alloc]initWithFrame:CGRectMake(0, self.frame.size.height * 0.3, self.frame.size.width, self.frame.size.height * 0.4)];
