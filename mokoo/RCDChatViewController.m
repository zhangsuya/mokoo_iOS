...
//    RCPluginBoardView
//    [self.pluginBoardView updateItemWithTag:1 image:[UIImage imageNamed:@"rc_ic_camera.pdf"] title:@"相机"];
    [self.pluginBoardView updateItemAtIndex:0 image:[UIImage imageNamed:@"rc_ic_picture.pdf"] title:@"相册"];
    [self.pluginBoardView updateItemAtIndex:1 image:[UIImage imageNamed:@"rc_ic_camera.pdf"] title:@"相机"];
    [self.pluginBoardView updateItemAtIndex:2 image:[UIImage imageNamed:@"rc_ic_location.pdf"] title:@"位置"];
...
- (void)notifyUpdateUnreadMessageCount {
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    ...
    UIImageView *backImg = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"top_back_b.pdf"]];
    backImg.frame = CGRectMake(0, 4, 8, 15);
