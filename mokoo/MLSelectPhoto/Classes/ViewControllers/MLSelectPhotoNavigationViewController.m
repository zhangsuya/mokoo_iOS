...
- (void)viewDidLoad{
    ...
    if ([rootVc isKindOfClass:[UINavigationController class]]) {
        ...
        [self.navigationBar setValue:viewBgColor forKeyPath:@"barTintColor"];
        [self.navigationBar setTintColor:blackFontColor];
        [self.navigationBar setTitleTextAttributes:@{NSForegroundColorAttributeName:blackFontColor}];
    }
}
@end
