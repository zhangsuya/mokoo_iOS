...
//        gradientBottomColor = [UIColor colorWithRed:myRed green:myGreen blue:myBlue alpha: 1];
        gradientTopColor = [UIColor colorWithWhite:0.35f alpha:1];
        gradientMiddleColor = [UIColor colorWithWhite:0.2f alpha:1];
        gradientBottomColor = [UIColor colorWithWhite:0.1f alpha:1];
    }
