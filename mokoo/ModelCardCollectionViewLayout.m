//
//  ModelCardCollectionViewLayout.m
//  mokoo
//
...
@interface ModelCardCollectionViewLayout()
@property(nonatomic,retain)NSMutableDictionary * maxYdic;
@end
@implementation ModelCardCollectionViewLayout
...
-(UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //    计算高度
    CGFloat hight = [self.degelate MCwaterFlow:self heightForWidth:width atIndexPath:indexPath];
    NSLog(@"-----%f",width);
