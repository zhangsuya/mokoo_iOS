...
//            NSInteger numberOfItemsInSection = [self.collectionView numberOfItemsInSection:1];
//            //得到第一个item的indexPath
//            NSIndexPath *firstItemIndexPath = [NSIndexPath indexPathForItem:0 inSection:1];
//            //得到最后一个item的indexPath
//            NSIndexPath *lastItemIndexPath = [NSIndexPath indexPathForItem:MAX(0, numberOfItemsInSection-1) inSection:1];
...
////            rect.origin.y = MIN(maxY,headerMissingY);
            if (attributes.frame.origin.y >0) {
                rect.origin.y = 0;
            }
//            rect.origin.y = maxY;
