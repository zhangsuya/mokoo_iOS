...
#define BaseMenuBackgroundColor(style)  (style == SGActionViewStyleLight ? [UIColor colorWithWhite:1.0 alpha:1.0] : [UIColor colorWithRed:0/255.0 green:0/255.0 blue:0/255.0 alpha:1])
