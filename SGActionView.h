...
typedef void(^SGChooseMenuActionHandler)(NSArray *selectedArray);
typedef void(^SGChooseStringActionHandler)(NSString *selectedString);

typedef void(^SGChooseFieldActionHandler)(NSDictionary *selectedDict);
