...
*/
//    now
    [_saveImageBtn setImage:[UIImage imageNamed:@"download_highlighted.png"] forState:UIControlStateNormal];
    [_saveImageBtn setImage:[UIImage imageNamed:@"download_highlighted.png"] forState:UIControlStateHighlighted];
//    now
